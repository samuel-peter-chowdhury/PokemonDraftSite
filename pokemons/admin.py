...
class DetailedMoveAdmin(admin.ModelAdmin):
    ...
    list_filter = [field.name for field in DetailedMove._meta.get_fields() if not field.is_relation]
...
class PokemonDetailedMoveAdmin(admin.ModelAdmin):
    ...
    list_filter = [field.name for field in PokemonDetailedMove._meta.get_fields() if not field.is_relation]
...
class TypeAdmin(admin.ModelAdmin):
    ...
    list_filter = [field.name for field in Type._meta.get_fields() if not field.is_relation]
...
class PokemonTypeAdmin(admin.ModelAdmin):
    ...
    list_filter = [field.name for field in PokemonType._meta.get_fields() if not field.is_relation]
...
class PokemonTypeEffectiveAdmin(admin.ModelAdmin):
    ...
    list_filter = [field.name for field in PokemonTypeEffective._meta.get_fields() if not field.is_relation]
...
class PokemonCoverageMoveAdmin(admin.ModelAdmin):
    ...
    list_filter = [field.name for field in PokemonCoverageMove._meta.get_fields() if not field.is_relation]
...
class PokemonSpecialMoveAdmin(admin.ModelAdmin):
    ...
    list_filter = [field.name for field in PokemonSpecialMove._meta.get_fields() if not field.is_relation]
...
class PokemonMoveAdmin(admin.ModelAdmin):
    ...
    list_filter = [field.name for field in PokemonMove._meta.get_fields() if not field.is_relation]
